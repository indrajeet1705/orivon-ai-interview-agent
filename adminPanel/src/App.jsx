...
const App = () => {
  ...
  const handleformsubmit= async(e)=>{
    e.preventDefault()
    const jobPost={
      orgName,role,jobDescription,experience
    }
    console.log(jobPost)
      ...
      <form onSubmit={handleformsubmit} className='mx-auto border rounded-lg flex flex-col p-10 md:w-[600px]  text-slate-900  gap-4 '>
       <h1 className=' flex text-5xl font-semibold  mx-auto mb-4 '>Create Job Post</h1>
          ...
          <div className='flex flex-col gap-2  '>
            ...
            <input value={orgName} onChange={(e)=>setOrgName(e.target.value)} type="text"  className='w-full rounded-xl text-sm  p-2 pl-4 outline-none border' placeholder='enter organozation name'/>
          </div>
          <div className='flex flex-col gap-2  '>
            <p>Job Role</p>
